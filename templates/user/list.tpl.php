            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.auths) {
                        ...
                        for(k in data.auths) {
                            div += '<div class="grid3">' +
                                   '<input name="auths[]" class="check checkAll" type="checkbox" id="ckb' + k +'" value="' + k + '" key="auths"/>' +
                    ...
                    div += '<div class="formRow" style="text-align: center;"><input class="checkAll check" key="auths" type="checkbox"><a style="color: #fff" href="javascript:;" class="buttonS bBlue" id="auth_save"><span>保存</span></a></div>';
                    div += '</div>';
